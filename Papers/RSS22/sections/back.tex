...
For any admissible control-disturbance pair $(\bm{u}(\cdot), \bm{v}(\cdot))$ and initial phase $(\state, T)$,  there exists a unique~\citet{Crandall1983viscosity, Evans1984} claim is that % $\xi(t)$ 
%
\begin{align}
