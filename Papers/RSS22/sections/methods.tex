...
\begin{itemize}
	...
	%
	\item  we then run the system's passive dynamics with $\{\control_r(t)\}, \{ {\disturb_r(t)} \}$ to generate  a nominal state trajectory $ \{\state_r(t)\}$, with neighboring trajectories $\{ \state(t) \}$; %deterministic dynamics,
	%
