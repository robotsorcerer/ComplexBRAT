...
%		\includegraphics[width=\textwidth]{figures/dint_ttr_1.5.jpg}
%	\end{minipage}
	%
	\begin{minipage}[b]{.95\textwidth}
...
\begin{figure}[tb!]
	\centering
	\begin{minipage}[b]{.45\textwidth}
		\includegraphics[width=\textwidth]{figures/rcbrt_0.25.jpg}
	\end{minipage}
	%	
	\begin{minipage}[b]{.45\textwidth}
		\includegraphics[width=\textwidth]{figures/rcbrt_1.0.jpg}
	\end{minipage}
	%
	\begin{minipage}[b]{.45\textwidth}
...
% see large BRAT notes

\begin{figure}[tb!]
	\centering
		\includegraphics[width=\columnwidth]{figures/flock_avoid_tube.jpg}
